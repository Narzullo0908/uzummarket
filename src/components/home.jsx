...
export default function Home() {
  ...
  return (
    <div className="px-25 max-md:px-2">
      ...
      />
      <div>
        <p className="font-bold text-[28px]">Arzon narxlar</p>
            ...
            return (
              ...
              >
                <div className="relative hover:shadow-[5px_5px_2px_0px_#00000014] rounded-[10px] transition-all duration-300">
                  <div className="w-full flex items-center rounded-[10px] justify-center h-100 object-cover bg-[#EFEFEF] p-5 mb-3">
                    <img src={item.image} alt="" />
                    <span className="absolute top-5 right-5 cursor-pointer bg-white rounded-4xl flex items-center justify-center p-1">
                      <CiHeart size={24} />
                    </span>
                  ...
                  <div className="flex flex-col justify-between h-50 p-3">
                    <span>
                      <p className="line-clamp-2 text-[#1F2026] text-[14px] font-medium mb-1.25">
                        {item.title}
                      </p>
                      <p className="line-clamp-2 mb-2 text-[15px]">
                        {item.description}
                      </p>
                      <p className="flex items-center text-3 gap-0.75 text-[#8B8E99] mb-3.75">
