  ...
  return (
    <div className="px-25 flex justify-between items-center max-md:flex-col max-md:px-2">
      ...
      <div className="w-[50%] border border-[#7000FF] rounded-[20px] p-10 max-md:w-full max-md:mt-10">
        ...
        <p className="text-3xl font-black text-[#7000FF] mb-5">${data.price}</p>
        <button className="w-full bg-[#7000FF] p-5 rounded-4xl text-white font-medium text-2xl">Add Card</button>
      </div>
    </div>
  );
}
