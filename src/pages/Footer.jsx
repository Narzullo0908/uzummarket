    ...
    <div className="px-25 mt-30 max-md:px-4 max-md:mt-10">
      <ul className="flex justify-between max-md:flex-col max-md:gap-8 mb-5">
        <li className="flex flex-col gap-3.75">
          <p className="text-[14px] font-medium">Biz haqimizda</p>
          <p className="text-[14px] text-[#8B8E99]">Topshirish punktlari</p>
          <p className="text-[14px] text-[#8B8E99]">Vakansiyalar</p>
        </li>

        <li className="flex flex-col gap-3.75">
          <p className="text-[14px] font-medium">Foydalanuvchilarga</p>
          <p className="text-[14px] text-[#8B8E99]">Biz bilan bogʻlanish</p>
          <p className="text-[14px] text-[#8B8E99]">Savol-Javob</p>
        </li>

        <li className="flex flex-col gap-3.75">
          <p className="text-[14px] font-medium">Tadbirkorlarga</p>
          <p className="text-[14px] text-[#8B8E99]">Uzumda soting</p>
        ...
        <li className="flex flex-col gap-3.75">
          <p className="text-[14px] font-medium">Ilovani yuklab olish</p>
      ...
      >
        <div className="flex flex-col gap-3">
          <p className="text-[14px] font-medium">Uzum ijtimoiy tarmoqlarda</p>
      ...
      >
        <div className="flex gap-5 max-md:flex-col max-md:gap-2">
          <p className="text-[14px] font-medium">Maxfiylik kelishuvi</p>
